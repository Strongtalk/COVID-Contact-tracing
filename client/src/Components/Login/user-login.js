...
return (
    ...
    <form id="login-form-container">
        ...
        <label id="labelUsername" htmlFor="username">Username:</label>
        <input id='user-name' type='text' name="username" />
        </div>
        <div id="password-container">
        <label id="labelPassword" htmlFor="pass">Password:</label>
        ...
        <input id='login-submit-button' value="Log In" type="submit" placeholder="submit" />
        </div>
    </form>
    </div>
)
